...
COPY ./pcrf.yaml /app/open5gs/install/etc/open5gs/pcrf.yaml

COPY ./pcrf_diameter.conf /app/open5gs/install/etc/freeDiameter/pcrf.conf

CMD ["/app/open5gs/install/bin/open5gs-pcrfd"]
