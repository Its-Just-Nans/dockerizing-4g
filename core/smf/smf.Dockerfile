...
COPY ./smf.yaml /app/open5gs/install/etc/open5gs/smf.yaml

COPY ./smf_freediameter.conf /app/open5gs/install/etc/open5gs/smf.conf

CMD ["/app/open5gs/install/bin/open5gs-smfd"]
